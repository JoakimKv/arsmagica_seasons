...
class SecretVault:
   ...
   def __init__(self):
      ...
      if self.currentOS == "Windows":
         ...
         self.envPath = Path(__file__).resolve().parent / ".django_env"
      ...
      # Otherwise assume Ubuntu server
         ...
         self.envPath = Path("/etc/secrets/mysql/keys/.django_env")
      ...
      self.productionDB = "db_arsmagica1"
      self.testDB = "db_arsmagica1_test"
