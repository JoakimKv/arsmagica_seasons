...
class GPTHandler:
   ...
   def summarizeText(self, input_text):
    ...
    try:
        ...
        response = openai.ChatCompletion.create(
           ...
           messages = [
                      ...
                      {"role": "user", "content": f"Summarize the following text concisely in a few sentences:\n\n{input_text}"}
           ],
           max_tokens = 300,
           temperature = 0.2
   ...
   def analyzeText(self, input_text):
    ...
    try:
        ...
        response = openai.ChatCompletion.create(
           ...
           messages = [
                      {"role": "system", "content": "You are a helpful assistant."},
                      {"role": "user", "content": f"Make a short analyze of the following text:\n\n{input_text}"}
           ],
           max_tokens = 600,
           temperature = 0.2
